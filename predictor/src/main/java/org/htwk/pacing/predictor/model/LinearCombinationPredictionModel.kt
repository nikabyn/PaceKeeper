...
import org.htwk.pacing.predictor.linalg.LinearAlgebraSolver
...
object LinearCombinationPredictionModel : IPredictionModel {
    ...
    private class Model(
        ...
        val perHorizonModels: Map<IPredictionModel.PredictionHorizon, PerHorizonModel>,
    ...
    private fun trainForHorizon(trainingSamples: List<TrainingSample>): PerHorizonModel {
        ...
        val coefficients = LinearAlgebraSolver.leastSquaresTikhonov(
            allExtrapolationsMatrix.transpose(),
            allExpectedFutureValuesVector
        ).toList()
    ...
    fun train(input: MultiTimeSeriesDiscrete, targetTimeSeriesDiscrete: DoubleArray) {
        ...
        val perHorizonModels = IPredictionModel.PredictionHorizon.entries.associateWith { predictionHorizon ->
