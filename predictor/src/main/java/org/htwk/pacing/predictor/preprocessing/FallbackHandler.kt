...
import org.htwk.pacing.predictor.preprocessing.FallbackHandler.ensureData
import org.htwk.pacing.predictor.preprocessing.FallbackHandler.generateDefaultDistanceSeries
import org.htwk.pacing.predictor.preprocessing.FallbackHandler.generateDefaultHeartRateSeries
import org.htwk.pacing.predictor.preprocessing.FallbackHandler.loadHistoricalDistanceData
import org.htwk.pacing.predictor.preprocessing.FallbackHandler.loadHistoricalHeartRateData
...
object FallbackHandler {
     ...
     *
     * @param start The [kotlinx.datetime.Instant] marking the beginning of the time range for which to load data.
     * @param duration The [Duration] of the time range.
     * @return A [List] of [org.htwk.pacing.backend.database.HeartRateEntry] objects containing the historical data. Returns an empty
     ...
     * @param start The [kotlinx.datetime.Instant] marking the beginning of the time range for which to load data.
     * @param duration The [Duration] of the time range.
     * @return A [List] of [org.htwk.pacing.backend.database.DistanceEntry] objects containing the historical data. Returns an empty
     *         list if no data is found or if the implementation is not yet complete.
     */
