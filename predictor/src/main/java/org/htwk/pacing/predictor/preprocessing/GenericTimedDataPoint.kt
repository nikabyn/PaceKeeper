...
fun ensureData(id: Int, genericTS: GenericTimedDataPointTimeSeries): GenericTimedDataPointTimeSeries {
    ...
    val data = List<GenericTimedDataPointTimeSeries.GenericTimedDataPoint>(steps) { index ->
...
data class GenericTimedDataPointTimeSeries(
     ...
     *
     * @property time The [kotlinx.datetime.Instant] at which the data point was recorded.
    ...
    data class GenericTimedDataPoint(
        ...
        /**
         * Secondary constructor to create a [GenericTimedDataPoint] from a [org.htwk.pacing.backend.database.HeartRateEntry].
         * @param src The source [org.htwk.pacing.backend.database.HeartRateEntry].
         */
        ...
        /**
         * Secondary constructor to create a [GenericTimedDataPoint] from a [org.htwk.pacing.backend.database.DistanceEntry].
         * The time is taken from the end of the distance interval, and the value is the length in meters.
         * @param src The source [org.htwk.pacing.backend.database.DistanceEntry].
         */
