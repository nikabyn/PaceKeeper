...
import org.htwk.pacing.predictor.model.LinearCombinationPredictionModel
import org.htwk.pacing.predictor.Predictor.train
...
import org.htwk.pacing.predictor.preprocessing.ensureData
...
object Predictor {
     ...
     * @return A [org.htwk.pacing.backend.database.PredictedEnergyLevelEntry] containing the forecasted energy level percentage and the timestamp for which the prediction is valid.
     */
    fun predict(
