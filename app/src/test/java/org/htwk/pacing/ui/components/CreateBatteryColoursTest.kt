...
class CreateBatteryColoursTest {
        ...
        fun testDefaultColorsWithAllSegments() {
            ...
            val expected = listOf(Color.Companion.Green, Color.Companion.Green, Color.Companion.Yellow, Color.Companion.Yellow, Color.Companion.Red, Color.Companion.Red)
        ...
        fun testColorOverrides() {
            ...
            val expected = listOf(Color.Companion.Green, Color.Companion.White, Color.Companion.Yellow, Color.Companion.White, Color.Companion.Red, Color.Companion.Red)
            Assert.assertEquals(expected, result)
        }
    ...
    fun testSegmentsLimit() {
        ...
        val expected = listOf(
            Color.Companion.Green, Color.Companion.Green,
            Color.Companion.Yellow, Color.Companion.Yellow)
        Assert.assertEquals(expected, result)
    }
